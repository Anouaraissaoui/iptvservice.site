...
export const ContactSEO = () => {
  ...
  return (
    <Helmet>
      ...
      <meta name="description" content="Get instant support for your IPTV service. Our 24/7 customer support team provides technical assistance, subscription help, and setup guidance." />
      ...
      <meta name="twitter:image:alt" content="IPTV Service" />
