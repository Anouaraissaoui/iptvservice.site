        ...
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="space-y-8 text-center">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed">
              Découvrez le streaming IPTV premium avec notre service fiable et de haute qualité. 
              Regardez vos contenus préférés n'importe quand, n'importe où.
            </p>
          ...
          <div className="pt-8 border-t border-white/10">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              <p className="text-gray-400 text-sm bg-white/5 px-6 py-2 rounded-full backdrop-blur-sm">
                © 2024 Service IPTV. Tous droits réservés.
              </p>
