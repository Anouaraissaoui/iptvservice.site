  ...
  return (
    <figure className="relative mt-8 lg:mt-0">
      ...
      <div className="relative bg-navy-light rounded-3xl border border-white/10 p-2 md:p-3 shadow-2xl transform hover:scale-[1.02] transition-transform duration-300 hover:border-primary/50">
        {isLoading && (
          <div className="absolute inset-0 bg-navy-light animate-pulse rounded-2xl" />
        )}
        <img 
          ...
          className={`relative rounded-2xl shadow-2xl w-full object-cover aspect-video transition-opacity duration-300 ${
        ...
        />
        {error && (
          <div className="absolute inset-0 flex items-center justify-center bg-navy-light rounded-2xl">
