...
const Hero = memo(() => {
  return (
    <header 
      className="relative min-h-[90vh] w-full pt-16 md:pt-20 pb-12 md:pb-16 bg-navy overflow-hidden"
    ...
    >
      ...
      <div className="container max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center relative">
        ...
        >
          ...
          >
            <span 
              className="text-primary animate-pulse font-semibold text-sm" 
            ...
            <Link 
              to="/features" 
              className="bg-gradient-to-r from-white to-white/60 bg-clip-text text-transparent text-sm hover:text-primary transition-colors"
              itemProp="url"
