...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="absolute -top-40 -right-40 w-[800px] h-[800px] bg-primary/20 rounded-full blur-[150px] animate-pulse" aria-hidden="true" />
      <div className="absolute -bottom-40 -left-40 w-[800px] h-[800px] bg-primary/10 rounded-full blur-[150px] animate-pulse" aria-hidden="true" />
