...
const Hero = () => {
  return (
    <div className="relative pt-32 pb-20 bg-navy overflow-hidden">
      ...
      <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-primary/20 rounded-full blur-3xl animate-pulse" />
      
      <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center relative">
        <div className="space-y-8">
          <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-2 backdrop-blur-xl">
            <span className="text-primary animate-pulse">New</span>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button className="bg-primary text-navy hover:bg-primary/90 text-lg px-8 h-14 group transition-all duration-300 transform hover:scale-105">
              Free Trial
        ...
        <div className="relative">
          ...
          <div className="relative bg-navy-light rounded-3xl border border-white/10 p-2 shadow-2xl transform hover:scale-[1.02] transition-transform duration-300">
            <img 
              src="https://ideogram.ai/assets/progressive-image/balanced/response/T-JUnqqgRsmp3yYR7L_s0g" 
              alt="Person watching TV" 
              className="relative rounded-2xl shadow-2xl"
            />
            <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-navy-light border border-white/10 rounded-xl p-4 shadow-xl backdrop-blur-xl">
