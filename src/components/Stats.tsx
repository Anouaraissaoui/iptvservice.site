...
const Stats = () => {
  ...
  return (
    <div className="py-12 md:py-20 bg-navy-light relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-3xl mx-auto text-center mb-8 md:mb-12">
          <span className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 md:px-6 py-2 backdrop-blur-xl text-sm mb-4">
            <span className="w-2 h-2 rounded-full bg-primary" />
            <span className="text-white">Why Choose Us?</span>
          </span>
          
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 tracking-tight bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="relative bg-navy-light/80 border border-white/10 rounded-2xl p-6 text-center hover:border-primary/50 transition-all duration-300 backdrop-blur-sm h-full">
                ...
                <p className="text-4xl font-bold bg-gradient-to-r from-primary to-primary/80 bg-clip-text text-transparent mb-2 group-hover:scale-110 transition-transform duration-300">
                  {stat.number}
                </p>
